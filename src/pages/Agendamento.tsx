            ...
            <div className="flex items-center justify-between max-w-2xl mx-auto">
              {[1, 2, 3, 4].map((stepNumber) => (
                <div key={stepNumber} className="flex items-center">
                  ...
                  <span className={`ml-2 text-sm ${step >= stepNumber ? 'text-green-600' : 'text-gray-600'}`}>
          ...
          {step === 1 && (
            <Card>
              ...
              <CardContent className="space-y-4">
                  ...
                  {servicos.map((servico) => (
                    ...
                    >
                      <CardContent className="p-4">
                        <h3 className="font-semibold">{servico.dsServico}</h3>
                        {servico.vrServico && (
                ...
                <Button onClick={handleServiceNext} className="w-full bg-green-600 hover:bg-green-700">
                  Continuar
                </Button>
              </CardContent>
            </Card>
          ...
          {step === 2 && (
            <div className="space-y-6">
              ...
              <div className="flex space-x-4">
                ...
                <Button onClick={handlePetNext} className="flex-1 bg-green-600 hover:bg-green-700">
                  Continuar
                </Button>
              </div>
            </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <Label className="text-base font-semibold mb-4 block">Horário</Label>
                ...
                <div className="flex space-x-4">
                  ...
                  <Button onClick={handleDateTimeNext} className="flex-1 bg-green-600 hover:bg-green-700">
                    Continuar
                  </Button>
                </div>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                <div className="bg-green-50 p-6 rounded-lg space-y-4">
                  <h3 className="font-semibold text-green-800 text-lg">Resumo do Agendamento</h3>
